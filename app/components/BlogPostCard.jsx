...
export default function BlogPostCard({ id, title, thumbnail, desc }) {
  ...
  return (
    <a href={`/program/${id}`} className={`hover:opacity-95`}>
      <div className={` rounded-2xl shadow-xl mb-3 grid grid-cols-2 mx-[5rem] gap-8`}>
          <ProgramCard
...
//       <div className={`${styles.cardContainer} rounded-2xl shadow-xl mb-3 grid grid-cols-2 mx-[5rem] gap-8`}>
