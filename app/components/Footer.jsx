...
export default function Footer() {
  return (
    <footer className="relative left-0 bottom-0 w-full px-10 md:lg:px-80 py-10 mt-10 bg-sky-500 text-white font-semibold hover:text-white/90 border border-t-gray-300">
